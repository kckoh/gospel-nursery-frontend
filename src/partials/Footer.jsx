...
import logo from '../images/gospel-logo.png'; 
    ...
    <footer>
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Top area: Blocks */}
          <div className="grid md:grid-cols-12 mb-4 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link to="/" className="inline-block" aria-label="Cruip">
                  <img src={logo} alt="Gospel Nursery Logo" className='w-8 h-8' />
                </Link>
              </div>
              <div className="text-gray-400">We are a private christian kindergarten and primary school with high quality education and facility in Rwanda.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; gospelnursery.com. All rights reserved.</div>
